...
The admission webhook is configured to recieve requests in namespaces that have a label "k8s-manifest-sigstore=true" .
...
```
To enable to check requests by integrity shield, `ManifestIntegrityProfile` should be defined.
